...
$query="SELECT * FROM pengajuan INNER JOIN pengguna ON pengajuan.pengguna_id = pengguna.pengguna_id INNER JOIN bidang ON pengguna.bidang_id = bidang.bidang_id INNER JOIN subbidang ON pengguna.subbidang_id = subbidang.subbidang_id WHERE pengajuan.pengajuan_status = '2' AND pengguna.bidang_id = '$bidang_id'";
...
?>
    <tr align="center" style="font-weight: bold;">
       ...
       ?></td>
       <td>
       <a href="index.php?page=ubah_pengajuan_ditolak&pengajuan_id=<?php echo $data['pengajuan_id'] ;?>" class="tombol"><span class="fa fa-edit" style="font-size: 15pt;"></span>&nbsp;UBAH</a>
       </td>
    </tr>
<?php
}
