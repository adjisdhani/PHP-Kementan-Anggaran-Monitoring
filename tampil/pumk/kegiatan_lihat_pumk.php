...
<!--<p align="center">Jumlah Anggaran :  <?php
                                          $a=mysql_query("SELECT SUM(kegiatan_anggaran) FROM kegiatan  LEFT JOIN pengguna ON kegiatan.pengguna_id=pengguna.pengguna_nip  WHERE pengguna.bidang_id='$bidang_id'");
