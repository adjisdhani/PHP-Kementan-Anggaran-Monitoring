...
<hr><br><br>
<form action="index.php?page=pelaporan_ubah_proses" method="post" enctype="multipart/form-data">
<?php
...
<table align="center">
    ...
    <tr>
		...
		<td></td>
		<td><input type="text" name="pelaporan_nama" value="<?php echo $d; ?>" required="required"></td>
	</tr>
	<tr>
		<td>Rincian Pelaporan</td>
		<td></td>
		<td>&nbsp;&nbsp;&nbsp;<textarea name="pengajuan_rincian" cols="60px;" rows="10px" required="required"><?php echo $e; ?></textarea></td>
	</tr>
	<tr>
