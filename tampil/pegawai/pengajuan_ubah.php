...
<p align="center" style="font-size: 25px; font-weight: bold">UBAH DATA PENGAJUAN</p>
<hr><br><br>
<form action="index.php?page=pengajuan_ubah_proses" method="post" enctype="multipart/form-data">
<?php
...
<table align="center">
    ...
    <tr>
		...
		<td></td>
		<td><input type="text" name="pengajuan_nama" value="<?php echo $d; ?>" required="required"></td>
	</tr>
	<tr>
		<td>Anggaran Pengajuan</td>
		<td></td>
		<td><input type="number" name="pengajuan_anggaran" required="required" value="<?php echo $e; ?>"></td>
	</tr>
	<tr>
		<td>Rincian Pengajuan</td>
		<td></td>
		<td>&nbsp;&nbsp;&nbsp;<textarea name="pengajuan_rincian" cols="60px;" rows="10px" required="required"><?php echo $f; ?></textarea></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
