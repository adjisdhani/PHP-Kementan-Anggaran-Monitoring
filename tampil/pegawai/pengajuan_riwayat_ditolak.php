...
$a="SELECT * FROM pengajuan LEFT JOIN pengguna ON pengajuan.pengguna_id = pengguna.pengguna_id WHERE pengajuan.pengajuan_status='2' AND pengajuan.pengguna_id = '$pengguna_id'";
...
?>
    <tr align="center">
      ...
      ?></td>
       ...
       <td><a class="tombol2" href="index.php?page=ubah_pengajuan_ditolak_pegawai&pengajuan_id=<?php echo $data['pengajuan_id']; ?>">UBAH</a></td>
    </tr>
<?php
}
?>
