...
$tampil="SELECT * FROM pengajuan INNER JOIN pengguna ON pengajuan.pengguna_id = pengguna.pengguna_id INNER JOIN bidang ON pengguna.bidang_id = bidang.bidang_id INNER JOIN subbidang ON pengguna.subbidang_id = subbidang.subbidang_id WHERE pengajuan.pengajuan_id='$pengajuan_id'";
$query=mysql_query($tampil);

$row=mysql_fetch_array($query);

$a=$row['pengajuan_no'];
$b=$row['pengajuan_statusben'];
$c=$row['pengajuan_nama'];
$d=$row['pengajuan_tanggal'];
$e=$row['pengajuan_anggaran'];
$f=$row['pengajuan_ben'];
$g=$row['pengajuan_tangsetuju'];

$querygetben = "SELECT * FROM pengguna WHERE pengguna_id = '$f'";
$resultgetben = mysql_query($querygetben);
$datagetben = mysql_fetch_array($resultgetben);
$namaben = $datagetben['pengguna_nama'];
$nipben = $datagetben['pengguna_nip'];
?>
<table border="0">
  <tr>
...
<table border="0" style="margin-left: 500px;">
  ...
  <tr>
    <td style="text-align: center"><br><br><br><br><?php echo $namaben ;?></td>
  </tr>
  <tr>
    <td>NIP  : <?php echo $nipben; ?></td>
  </tr>
</table>
</body>
