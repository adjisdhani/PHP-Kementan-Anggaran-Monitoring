...
<input type="hidden" name="page" value="kegiatanpegawai_cetak">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" name="d1" class="s" required="required"><input type="date" name="d2" class="s" required="required"><select name="kegiatan_status" class="s" required="required">
            <option value="">--</option>
...
?>
<br>
<p style="margin-left: -970px;"><a class="tombol" href="tampil/laporan/laporankegiatanpegawai.php?d1=<?php echo $d1;?>&d2=<?php echo $d2;?>&kegiatan_status=<?php echo $d3;?>" target="_NEW"><span class="fa fa-print" style="font-size: 15pt;"></span>&nbsp;CETAK</a><p>
<br><br>
  <thead>
