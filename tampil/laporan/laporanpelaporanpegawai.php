...
$query="SELECT * FROM pelaporan LEFT JOIN pengguna ON pelaporan.pengguna_id = pengguna.pengguna_id WHERE pelaporan.pelaporan_status IN ('$d3%') AND pelaporan.pelaporan_tanggal BETWEEN '$d1' AND '$d2'";
...
?>
<tr>
      <td><?php echo $data['pelaporan_no'];  ?></a></td>
