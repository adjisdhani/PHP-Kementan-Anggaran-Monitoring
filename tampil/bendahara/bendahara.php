...
<tr>
			...
			<tr>
				...
				<tr>
					...
					<td style="vertical-align: right">
						...
						<?php
						$queryjumpem = "SELECT * FROM pengajuan LEFT JOIN pengguna ON pengajuan.pengguna_id = pengguna.pengguna_id LEFT JOIN bidang ON pengguna.bidang_id = bidang.bidang_id LEFT JOIN subbidang ON pengguna.subbidang_id = subbidang.subbidang_id where pengajuan.pengajuan_status='1' AND pengajuan.pengajuan_statusben='1'";
	...
	<td>
		<table frame="box" style="background-color: #036d0a;color: white;" cellpadding="0" cellspacing="0" width="200px">
			<tr>
					<td colspan="2">
						<h3 align="right" style="font-size:15px;">Kegiatan</h3>
					</td>
			</tr>
				<tr>
				    <td style="vertical-align: center" width="250px">
					...
					<td style="vertical-align: right">
						<h3 align="center" style="margin: 0; padding:0">
						<?php
						$queryjumpem = "SELECT * FROM kegiatan LEFT JOIN judul ON kegiatan.judul_id=judul.judul_id LEFT JOIN subjudul ON kegiatan.subjudul_id=subjudul.subjudul_id LEFT JOIN pengguna ON kegiatan.pengguna_id=pengguna.pengguna_nip LEFT JOIN bidang ON pengguna.bidang_id =bidang.bidang_id LEFT JOIN subbidang ON pengguna.subbidang_id=subbidang.subbidang_id WHERE kegiatan.kegiatan_status='1'";
						$resultjumpem = mysql_query($queryjumpem);
						$jumpem = mysql_num_rows($resultjumpem);
						echo $jumpem;
						?>
	...
	<td>
		<table frame="box" style="background-color: #036d0a;color: white;" cellpadding="0" cellspacing="0" width="240px" >
			<tr>
					<td colspan="2">
						<h3 align="right">Anggaran Sisa</h3>
					</td>
			</tr>
				<tr>
				    <td style="vertical-align: center" width="300px">
					...
					<td style="vertical-align: right">
						<h3 align="center" style="margin: 0; padding:0">
						<?php
						 $a=mysql_query("SELECT SUM(realisasi_sisa) FROM realisasi");
                                          $data=mysql_fetch_array($a);
                                          $jumlah=$data[0];
                                          $angka=$jumlah;
                                                  $jumlah_desimal='2';
...
<tr>
  <td>
   <table>
	...
	<tr>
		<td>Anda terdaftar sebagai Bendahara</td>
	</tr>
	<tr>
...
<tr>
   ...
   <table>
   <tr>
		<td>Tata cara           : <a href="index.php?page=tatacarabendahara">DISINI</a></td>
	</tr>
	<!--<tr>
		<td>Tata cara Pengajuan : <a href="">DISINI</a></td>
	</tr>
	<tr>
		<td>Tata cara Pelaporan : <a href="">DISINI</a></td>
	</tr>-->
	<td>
</table>