...
<form action="index.php?page=subjudul_tambah_proses" method="post" enctype="multipart/form-data">
<h2 style="margin-left: -130px;">TAMBAH DATA SUB JUDUL KEGIATAN</h2>
<br><hr><br>
<table style="margin-left: 20px;" class="a">
	<tr>
		<td>Nama Sub Judul Kegiatan</td>
		<td>:</td>
		<td><input type="text" name="subjudul_nama" required="required" class="anu"></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
